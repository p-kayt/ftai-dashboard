...
export default function PackageStatus({ order }) {
  ...
  return (
    <div>
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <Chip
            ...
            label={processNumber(order.status)}
            color={processNumberColor(order.status)}
          />
        </div>
        <div style={styles.content}>
          ...
          <div style={styles.details}>
            <div style={styles.detailsLeft}>
              ...
              <div style={styles.detailsAddress}>
      ...
      {order.status === 3 && (
        <div style={{ ...styles.container, marginTop: "15px" }}>
          <div style={styles.header}>
          ...
          <div style={styles.content}>
            <Box fullWidth>
              <Textarea
                ...
                disabled
                defaultValue={order.cancelReason}
                style={{ resize: "none" }}
              />
            </Box>
          </div>
