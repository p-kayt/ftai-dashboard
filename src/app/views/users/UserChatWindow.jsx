...
export default function UserChatWindow({ activeUserId, listUser }) {
    ...
    return (
        <div>
            ...
            <div style={{ gap: '20px', width: '100%', padding: '20px', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <TextField
                    inputRef={inputRef}
                ...
                />
                <Button sx={{ width: '10%' }} color='info' variant='contained' onClick={handleSendMassage}>Send</Button>
            </div>
        </div>
    )
}
